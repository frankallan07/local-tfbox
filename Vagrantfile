...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder TF_FOLDER, "/home/tfcode"
...
pushd /opt/terraform
wget -nc -q https://releases.hashicorp.com/terraform/1.5.5/terraform_1.5.5_linux_amd64.zip
unzip -q terraform_1.5.5_linux_amd64.zip
popd
